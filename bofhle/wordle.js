this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  #privacy-policy,\n  #copyright {\n    text-align: left;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Hard Mode</div>\n          <div class="description">Any revealed hints must be used in subsequent guesses</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Dark Theme</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Color Blind Mode</div>\n          <div class="description">High contrast colors</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Feedback</div>\n        </div>\n        <div class="control">\n          <a href="mailto:bofhle@sysarmy.com?subject=Bofhle Feedback" title="bohfle@sysarmy.com">Email</a>\n          |\n          <a href="https://twitter.com/intent/tweet?screen_name=sysarmy" target="blank" title="@sysarmy">Twitter</a>\n        </div>\n      </div>\n    </section>\n  </div>\n  <div id="footnote">\n    <div>\n      <div id="privacy-policy">Based on <a href="https://github.com/sneakers-the-rat/local_wordle">Local Wordle</a>.<br /><a href="https://www.powerlanguage.co.uk/privacy-policy.html" target="_blank">Privacy Policy</a><div id="copyright"></div>\n      </div>\n    </div>\n    <div>\n      <div id="puzzle-number"></div>\n      <div id="hash"></div>\n    </div>\n  </div>\n';
    var _a = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
...
"nginx"
    ...
    var Ha = new Date(2022, 5, 10, 0, 0, 0, 0);
    function Na(e, a) {
        var s = new Date(e),
    ...
    var Za = "IN_PROGRESS",
        es = "WIN",
        as = "FAIL",
        ss = ["BOFH", "Unix Guru", "H4x0r", "10x Engineer", "Bash Master", "PEBKAC"],
        ts = function(e) {
            r(t, e);
            var a = h(t);
            function t() {
            ...
            return o(t, [{
                    ...
                    value: function() {
                        if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                            ...
                            if (e = s, !Ta.includes(e) && !La.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Not in command list");
                            if (this.hardMode) {
    ...
    $s.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p><strong>  System Administrator Appreciation Day - July 29, 2022</strong></p><p>Sysarmy, the support of those who give support, invites you to guess the <strong>#BOFLE</strong> in 6 tries.</p>\n      <p>Each guess must be a valid 5 letter Unix/Linux command. Hit the enter button to submit.</p>\n      <p>After each guess, the color of the tiles will change to show how close your guess was to the command.</p>\n      <div class="examples">\n        <p><strong>Examples</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="N" evaluation="correct" reveal></game-tile>\n            <game-tile letter="G"></game-tile>\n            <game-tile letter="I"></game-tile>\n            <game-tile letter="N"></game-tile>\n            <game-tile letter="X"></game-tile>\n          </div>\n          <p>The letter <strong>N</strong> is in the command and in the correct spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="C"></game-tile>\n            <game-tile letter="J" evaluation="present" reveal></game-tile>\n            <game-tile letter="P"></game-tile>\n            <game-tile letter="E"></game-tile>\n            <game-tile letter="G"></game-tile>\n          </div>\n          <p>The letter <strong>J</strong> is in the command but in the wrong spot.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="J"></game-tile>\n            <game-tile letter="A"></game-tile>\n            <game-tile letter="V"></game-tile>\n            <game-tile letter="A"></game-tile>\n            <game-tile letter="H" evaluation="absent" reveal></game-tile>\n          </div>\n          <p>The letter <strong>H</strong> is not in the command in any spot.</p>\n        </div>\n      </div>\n      <p><strong>A new #BOFHLE will be available each day!<strong></p>\n    </div>\n  </section>\n';
    var Hs = function(e) {
        r(t, e);
        var a = h(t);
        function t() {
